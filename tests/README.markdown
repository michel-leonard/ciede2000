...
> [!TIP]  
> An [online tool](https://michel-leonard.github.io/ciede2000/samples.html) is available to easily generate more CIEDE2000 color difference test samples in JSON or CSV format.

## Results & Reliability

Tests [confirm](logs.txt#L174) that the computed **CIE ΔE2000** values remain identical, regardless of the programming language used for implementation.
